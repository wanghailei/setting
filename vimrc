...
" Encoding
set encoding=utf-8  " Set the GUI's encoding.
set termencoding=utf-8
set fileencoding=utf-8  " The encoding written to file.
set fileencodings=ucs-bom,utf-8,cp936,cp950,euc-cn,euc-tw,gb18030,big5,euc-jp,latin1
"set langmenu=zh_CN.utf-8

" Use Unix as the sandard file type
...
au FileType python setl ofu=pythoncomplete#Complete ts=8 sw=8 sts=0
...
"Just use the default green colour of Terminal
